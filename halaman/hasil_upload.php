...
$query = "INSERT INTO tb_dokumen VALUES ('', '$_POST[Judul]', '$teks','$nama_file')";
...
$myArray = explode(" ", $teks); //proses Termisasi
...
WHERE TermStem = '$hasil' AND DocId = $DocId");                  
...
WHERE TermStem = '$hasil' AND DocId = $DocId");
                                  ...
                                  //jika belum ada, langsung simpan ke tb_proses                 
                                         ...
                                         mysqli_query($koneksi,"INSERT INTO tb_proses (Term,TermStem, DocId, 
Count) VALUES ('$filteredarray','$hasil', $DocId, 1)");
