<div class="col-md-3 left_col">
  <div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
      <a href="index.php" class="site_title"><i class="fa fa-desktop"></i> <span>STBI UU</span></a>
    </div>
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        <ul class="nav side-menu">
              <li><a href="index.php?link=pencariandokumen"><i class="fa fa-search"></i> Pencarian Dokumen</a>
  </li>
          <li><a href="index.php?link=stbi"><i class="fa fa-book"></i> STBI</a>
        </li>
  ...
  <li><a href="index.php?link=resetdata" onclick="return confirm('Reset Data akan menghapus semua data ! Lanjutkan ?')"><i class="fa fa-exclamation-triangle"></i> Reset Data</a>
</li>
</ul>
</div>
